...
- Next: plan 2C (menu rewrite), design approved 2026-09-23, plan at
  `docs/superpowers/plans/2026-09-23-phase-2c-menu-rewrite.md`, the first plan through the loop.
- Then 2D (branding), 2E (provisioning and install), 2F (session integration), Phase 3
