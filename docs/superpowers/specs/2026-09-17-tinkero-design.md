...
**Status:** revision 2.1, 2026-09-21. Phase 0 spike done (`docs/research/phase-0-findings.md`, GO on Phase 1); plans 2A and 2B executed; Phase 1 done 2026-09-22 (the package set builds in `dromero/tinkero`); 2C (menu rewrite) done 2026-09-23; 2E (provisioning and install) done 2026-09-23 (design: 2026-09-23-phase-2e-provision-design.md); 2D (branding) done 2026-09-24 (design: 2026-09-23-phase-2d-branding-design.md). Fedora 44 x86_64 is the first target.
